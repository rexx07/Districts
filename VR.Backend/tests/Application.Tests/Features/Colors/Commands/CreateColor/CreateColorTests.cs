...
public class CreateColorTests : ColorMockRepository
{
    ...
    private readonly CreateColorCommand.CreateColorCommandHandler _handler;
        ...
        : base(fakeData)
    {
        ...
        _command = command;
        _handler = new CreateColorCommand.CreateColorCommandHandler(MockRepository.Object, Mapper, BusinessRules);
    }

...
public class UpdateColorTests : ColorMockRepository
{
    ...
    private readonly UpdateColorCommand.UpdateColorCommandHandler _handler;
        ...
        : base(fakeData)
    {
        ...
        _command = command;
        _handler = new UpdateColorCommand.UpdateColorCommandHandler(MockRepository.Object, Mapper, BusinessRules);
    }

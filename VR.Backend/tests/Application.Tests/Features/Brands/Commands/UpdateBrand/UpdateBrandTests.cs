...
public class UpdateBrandTests : BrandMockRepository
{
    ...
    private readonly UpdateBrandCommand.UpdateBrandCommandHandler _handler;
        ...
        : base(fakeData)
    {
        ...
        _command = command;
        _handler = new UpdateBrandCommand.UpdateBrandCommandHandler(MockRepository.Object, Mapper, BusinessRules);
    }

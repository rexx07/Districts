using Infrastructure.Common.Exceptions.Extensions;
using Infrastructure.Common.Exceptions.HttpProblemDetails;
using Infrastructure.Common.Exceptions.Types;
using Microsoft.AspNetCore.Http;

namespace Infrastructure.Common.Exceptions.Handlers;

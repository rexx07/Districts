...
namespace Modules.AirTransport.Queries;
...
public sealed class GetAvailableFlightsQueryHandler: IQueryHandler<GetAvailableFlightsQuery, IEnumerable<FlightResponseDto>>
{

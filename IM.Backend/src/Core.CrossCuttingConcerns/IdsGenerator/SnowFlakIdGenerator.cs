...
namespace Core.CrossCuttingConcerns.IdsGenerator;
...
public static class SnowFlakIdGenerator
{
    ...
    {
        Guard.Against.NegativeOrZero(generatorId, parameterName: nameof(generatorId));
        ...
        // Prepare options
        var options = new IdGeneratorOptions(structure, timeSource: new DefaultTimeSource(epoch));

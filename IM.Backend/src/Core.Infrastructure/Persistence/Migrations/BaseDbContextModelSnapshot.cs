...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.AdditionalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.FindeksCreditRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Fuel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.IndividualCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.RentalBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.RentalsAdditionalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Transmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Model", "Model")
                        .WithMany("Cars")
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.RentalBranch", "RentalBranch")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("Core.Domain.Entities.CorporateCustomer", b =>
                {
                    b.HasOne("Core.Domain.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("Core.Domain.Entities.CorporateCustomer", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.FindeksCreditRate", b =>
                {
                    b.HasOne("Core.Domain.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("Core.Domain.Entities.FindeksCreditRate", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.IndividualCustomer", b =>
                {
                    b.HasOne("Core.Domain.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("Core.Domain.Entities.IndividualCustomer", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.Model", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Fuel", "Fuel")
                        .WithMany("Models")
                        .HasForeignKey("FuelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.Transmission", "Transmission")
                        .WithMany("Models")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Rental", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.RentalBranch", "RentEndRentalBranch")
                        .WithOne()
                        .HasForeignKey("Core.Domain.Entities.Rental", "RentEndRentalBranchId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Core.Domain.Entities.RentalBranch", "RentStartRentalBranch")
                        .WithOne()
                        .HasForeignKey("Core.Domain.Entities.Rental", "RentStartRentalBranchId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.RentalsAdditionalService", b =>
                {
                    b.HasOne("Core.Domain.Entities.AdditionalService", "AdditionalService")
                        .WithMany()
